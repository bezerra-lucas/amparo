    ...
    <main>
      ...
      <section>
        ...
        <div className="flex flex-wrap gap-2">
          <Button type="button">{tabs('admission')}</Button>
          <Button type="button">{tabs('supplies')}</Button>
          <Button type="button">{tabs('nursing')}</Button>
          <Button type="button">{tabs('prescriptions')}</Button>
          <Button type="button">{tabs('mar')}</Button>
          <Button type="button">{tabs('billing')}</Button>
        </div>
      </section>
      <section>
        <h2>{tabs('admission')}</h2>
          ...
          {[bpSupplies('sampleItem1'), bpSupplies('sampleItem2')].map(
            (item) => (
              <Card key={item} className="space-y-2">
                ...
                <div className="grid gap-1 text-sm text-slate-800">
                  <div>
                    <strong>{bpSupplies('balance')}:</strong> {samples('qty12')}
                  </div>
                  <div>
          ...
          {[bpBilling('open'), bpBilling('paid'), bpBilling('late')].map(
            (st) => (
              <Card key={st} className="space-y-2">
                ...
                <div className="grid gap-1 text-sm text-slate-800">
                  <div>
                    <strong>{bpBilling('due')}:</strong> {samples('billingDue')}
                  </div>
                  <div>
